...
cut -f1-12 VarLD_KletKowa_arenosa.csv > VarLD_Klet_arenosa.table
cut -f1-3,13-20 VarLD_KletKowa_arenosa.csv > VarLD_Kowa_arenosa.table

chr=1
grep "scaffold_1[^[:digit:]]"  VarLD_Klet_arenosa.table | cut -f2-13 > File1.txt
grep "scaffold_1[^[:digit:]]"  VarLD_Kowa_arenosa.table | cut -f2-10 > File2.txt
...
for chr in $(seq 2 8)
do
	grep "scaffold_"$chr"[^[:digit:]]" VarLD_Klet.table | cut -f2-12 > File1.txt
	grep "scaffold_"$chr"[^[:digit:]]" VarLD_Kowa.table | cut -f2-11 > File2.txt
